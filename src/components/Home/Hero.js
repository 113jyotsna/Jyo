        ...
        <div className='bg-center bg-cover bg-fixed bg-no-repeat h-screen md:w-full'
          ...
          <div className='flex flex-col h-full px-4 md:ml-auto md:mt-auto w-full md:w-1/2 justify-center text-white font-display space-y-4 md:space-y-6'>
            <p className='text-3xl md:text-5xl '>
              Exotic Events  <br></br> Live in the Moments
            </p>
            <p className='font-light text-lg sm:text-2xl'>Registering for Events Has Never Been Easier</p>
            <Link to="/shop/:collection">
              <button className='bg-red-500 font-body rounded-md text-lg sm:text-2xl p-2 sm:p-4 w-32 sm:w-48 transform duration-200 hover:-translate-y-1 hover:bg-red-600 '>Register Now</button>
            </Link>
